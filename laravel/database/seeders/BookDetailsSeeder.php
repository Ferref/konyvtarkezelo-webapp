...
class BookDetailsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('book_details')->insert([
            ...
            [
                'title'=> 'Macbeth',
                'description'=> 'Ambition, power and tragedy in medieval Scotland.',
                'isbn'=> '1234567890134',
                'cover_path'=> 'covers/macbeth.jpg',
                'author_id'=> 1,
                'language_id'=> 1,
                'genre_id'=> 2,
                'created_at'=> now(),
            ...
            [
                ...
                'description'=> 'Poirot investigates murder aboard a Nile cruise.',
                'isbn'=> '1234567890136',
                'cover_path'=> 'covers/nile.jpg',
                'author_id'=> 2,
                'language_id'=> 1,
                'genre_id'=> 3,
                'created_at'=> now(),
            ...
            [
                'title'=> 'Carrie',
                'description'=> 'A bullied teenage girl unleashes telekinetic vengeance.',
                'isbn'=> '1234567890139',
                'cover_path'=> 'covers/carrie.jpg',
                'author_id'=> 3,
                'language_id'=> 1,
                'genre_id'=> 1,
                'created_at'=> now(),
